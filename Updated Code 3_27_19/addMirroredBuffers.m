...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% [bufferedData,bufferBins] = addMirroredBuffers(eegData,frequencies,samplingRate,bufferCycles)
%
...
% Calculate the length of the buffer in milliseconds and in EEG samples
bufferMS   = bufferCycles / min(frequencies) * 1000;
bufferBins = bufferMS / 1000 * samplingRate;
