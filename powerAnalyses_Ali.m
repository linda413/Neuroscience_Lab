...
directoryPath = '/shared/Ali/STBI Barnes Maze Examples/Barnes Baselines/';
...
codesFile = 'ALIADDSOMETHINGHERE.xlsx';
...
% ALI: USE 0 for Baseline files and 1 for actual Barnes sessions
